...
local java_on_attach = function(client, bufnr)
	...
	vim.keymap.set("n", "<leader>oi", jdtls.organize_imports, opts, "Organize imports")
	vim.keymap.set("n", "<leader>ev", jdtls.extract_variable, opts, "Extract variable")
	vim.keympa.set("n", "<space>ec", jdtls.extract_constant, opts, "Extract constant")
	vim.keymap.set(
		"v",
		"<space>em",
